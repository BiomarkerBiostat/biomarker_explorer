    ...
    fluidRow(
      ...
      column(
        ...
        fluidRow(
          ...
          column(
            width = 3,
            uiOutput('ass_download_sum_table_action'),
            bsTooltip('ass_download_sum_table_action', paste(
              'Click to open a window to specify the attributes',
              'of the table to be download'
            ))
          )
        ...
        shinyBS::bsModal(
          'ass_sum_table_bsmodal', 'Download page', 'ass_download_sum_table_action',
          size = 'large',
          fluidRow(
            column(
              width = 3,
              selectInput(
                'ass_download_sum_table_format', 'Table format',
                choices = c('Choose' = '', ass_download_sum_table_formats)
              )
            ),
            column(width = 3, uiOutput('ass_download_sum_table_height')),
            column(width = 3, uiOutput('ass_download_sum_table_width')),
            column(width = 3, uiOutput('ass_download_sum_table_button'))
          ),
          tags$style(type='text/css', "#ass_download_sum_table_button {vertical-align: bottom;}")
        ),                
